...
const AboutPage = () => {
  ...
  return (
    <InfoPage title="About Adimera">
      <div className="about-page">
        <div className="about-top">
          Adimera is an online platform that enable users to execute business
          deals from purchase to delivery with gratifying options.
        </div>
        <div
