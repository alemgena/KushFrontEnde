...
const YehagereCategories = () => {
  ...
  return (
    <div className="yehagere-categories">
          ...
          return (
            <Col sm={12} md={4}>
              <div className="category">
                ...
                <button className="yehagere-btn btn" onClick={()=>{history.push(`/categories/${item.catagory_Name}`);}}>Shop Now</button>
              </div>
            </Col>
          );
        })}
...
export default YehagereCategories;
